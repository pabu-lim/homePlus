...
if (isset($_SESSION['userBusinessNumber'])) {
    $loggedInUserBusinessNumber = $_SESSION['userBusinessNumber'];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $returnUrl = 'https://7ca7-223-38-81-187.ngrok-free.app/_finding.php';
    ...
    echo '<p class="error-msg">로그인 후에 거래내역을 입력할 수 있습니다.</p>';
}
?>
